...
axiom_cmv_reg 115 $GAIN      # gain
axiom_cmv_reg 116 $ADC_RANGE # ADC_range fine-tuned for each gain
axiom_cmv_reg 100 1          # ADC_range_mult2
axiom_cmv_reg 87 2000        # offset 1
axiom_cmv_reg 88 2000        # offset 2
