...
set_false_path -from [get_cells -hierarchical reg_ba_reg* -include_replicated_objects]
set_false_path -from [get_cells -hierarchical reg_ab_reg* -include_replicated_objects]

set_false_path -from [get_cells -hierarchical ping_a_d_reg* -include_replicated_objects]
set_false_path -from [get_cells -hierarchical pong_b_d_reg* -include_replicated_objects]

# set_false_path -from [get_pins fifo_reset_inst*/shift_*/C]
set_false_path -from [get_pins fifo_reset_inst*/*/C]

# set_false_path -from [get_pins reg_file_inst*/oreg_*/C]
# set_false_path -to [get_pins reg_file_inst*/rdata_*/D]
set_false_path -through [get_pins reg_file_inst*/oreg*]
set_false_path -through [get_pins reg_file_inst*/ireg*]

set_false_path -to [get_pins raw_delay_inst1/shift_*/D -include_replicated_objects]

set_false_path -to [get_pins sync_*_inst*/shift_*/D -include_replicated_objects]
# set_false_path -to [get_pins sync_*_inst/shift_*/PRE]

set_false_path -from [get_pins cseq_fcnt_reg*/C] -to [get_pins raw_out_reg*/D]
...
set_property IS_SOFT FALSE [get_pblocks pblock_ragen]
...
resize_pblock [get_pblocks pblock_ragen] -add {SLICE_X34Y25:SLICE_X49Y59}
resize_pblock [get_pblocks pblock_ragen] -add {DSP48_X2Y12:DSP48_X2Y19}
...
resize_pblock [get_pblocks pblock_rfifo] -add {SLICE_X26Y32:SLICE_X29Y44}
...
resize_pblock [get_pblocks pblock_writer] -add {SLICE_X26Y80:SLICE_X35Y91}
...
resize_pblock [get_pblocks pblock_wagen] -add {SLICE_X26Y60:SLICE_X35Y79}
...
resize_pblock [get_pblocks pblock_wfifo] -add {SLICE_X38Y70:SLICE_X49Y79}
...
set_property IS_SOFT FALSE [get_pblocks pblock_file0]
add_cells_to_pblock [get_pblocks pblock_file0] [get_cells reg_file_inst0 -include_replicated_objects]
...
set_property IS_SOFT FALSE [get_pblocks pblock_file1]
add_cells_to_pblock [get_pblocks pblock_file1] [get_cells reg_file_inst1 -include_replicated_objects]
...
resize_pblock [get_pblocks pblock_file1] -add {SLICE_X30Y12:SLICE_X49Y24}
...
set_property IS_SOFT FALSE [get_pblocks pblock_file2]
add_cells_to_pblock [get_pblocks pblock_file2] [get_cells reg_file_inst2 -include_replicated_objects]
resize_pblock [get_pblocks pblock_file2] -add {SLICE_X50Y0:SLICE_X83Y11}
resize_pblock [get_pblocks pblock_file2] -add {SLICE_X50Y50:SLICE_X83Y59}
...
set_property IS_SOFT FALSE [get_pblocks pblock_file3]
add_cells_to_pblock [get_pblocks pblock_file3] [get_cells reg_file_inst3 -include_replicated_objects]
resize_pblock [get_pblocks pblock_file3] -add {SLICE_X54Y25:SLICE_X89Y49}
...
set_property IS_SOFT FALSE [get_pblocks pblock_scan]
...
resize_pblock [get_pblocks pblock_scan] -add {SLICE_X16Y0:SLICE_X49Y11}
resize_pblock [get_pblocks pblock_scan] -add {DSP48_X1Y0:DSP48_X2Y3}

create_pblock pblock_hdmi
set_property IS_SOFT FALSE [get_pblocks pblock_hdmi]
add_cells_to_pblock [get_pblocks pblock_hdmi] [get_cells rgb_hdmi_inst0]
add_cells_to_pblock [get_pblocks pblock_hdmi] [get_cells rgb_hdmi_inst1]
add_cells_to_pblock [get_pblocks pblock_hdmi] [get_cells rgb_hdmi_inst2]
resize_pblock [get_pblocks pblock_hdmi] -add {SLICE_X50Y12:SLICE_X83Y24}
resize_pblock [get_pblocks pblock_hdmi] -add {SLICE_X106Y50:SLICE_X109Y89}
resize_pblock [get_pblocks pblock_hdmi] -add {SLICE_X106Y110:SLICE_X109Y149}
resize_pblock [get_pblocks pblock_hdmi] -add {OLOGIC_X0Y0:OLOGIC_X0Y49}
resize_pblock [get_pblocks pblock_hdmi] -add {OLOGIC_X1Y0:OLOGIC_X1Y149}
...
resize_pblock [get_pblocks pblock_glut] -add {SLICE_X90Y0:SLICE_X93Y49}
...
set_property IS_SOFT FALSE [get_pblocks pblock_axi0]
...
set_property IS_SOFT FALSE [get_pblocks pblock_axi1]
...
resize_pblock [get_pblocks pblock_axi1] -add {SLICE_X50Y25:SLICE_X53Y49}
...
resize_pblock [get_pblocks pblock_par] -add {ILOGIC_X0Y0:ILOGIC_X0Y49}
resize_pblock [get_pblocks pblock_par] -add {ILOGIC_X1Y0:ILOGIC_X1Y149}
...
resize_pblock [get_pblocks pblock_reme] -add {SLICE_X58Y110:SLICE_X63Y139}
...
resize_pblock [get_pblocks pblock_remo] -add {SLICE_X58Y60:SLICE_X63Y89}
